...
test('Browser Run schema cannot prevent computer, CLI, and evaluation tools from registering', async()=>{
 ...
 assert.ok(tools[3].parameters.properties.action.enum.includes('launch_game_pair'));
 assert.ok(tools[3].parameters.properties.action.enum.includes('pair_screenshot'));
