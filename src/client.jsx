...
export const name = 'darask-harness-client'
...
export function apply(ctx) {
  ...
  ctx.effect(() => ctx.locale.register('settings.grok', 'ja', grokJa), 'darask-harness: Grok Japanese')
  ctx.effect(() => ctx.locale.register('settings.openai-codex', 'ja', codexJa), 'darask-harness: Codex Japanese')
