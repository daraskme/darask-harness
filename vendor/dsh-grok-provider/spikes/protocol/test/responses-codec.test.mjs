...
// DARASK: these fixtures are truly empty (no encrypted replay); encrypted-only replay is covered by grok-regression.test.mjs.
  ...
  const cases = [
    {
      ...
      done: { id: "rs_empty_summary", type: "reasoning", status: "completed", summary: [{ type: "summary_text", text: "" }] },
    },
    {
      label: "raw",
      ...
      done: { id: "rs_empty_raw", type: "reasoning", status: "completed", content: [{ type: "reasoning_text", text: "" }], summary: [] },
    },
  ]
...
test("a later completed reasoning block waits for an earlier empty reasoning decision", () => {
  ...
  const events = [
    ...
    { type: "response.output_item.done", sequence_number: 9, output_index: 0, item: { id: "rs_earlier_empty", type: "reasoning", status: "completed", summary: [] } },
