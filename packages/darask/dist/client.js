  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "darask darask-dashboard", "data-peek": peek ? "" : void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "darask-dashboard-list", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "darask-dashboard-toolbar", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "darask-dashboard-control", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u30B0\u30EB\u30FC\u30D7\u5316" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("select", { value: prefs.grouping, onChange: (event) => update({ grouping: event.target.value }), children: GROUPINGS.map((value) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value, children: GROUPING_LABEL[value] }, value)) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "darask-dashboard-control", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u30D5\u30A3\u30EB\u30BF\u30FC" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("select", { value: prefs.filter, onChange: (event) => update({ filter: event.target.value }), children: FILTERS.map((value) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value, children: FILTER_LABEL[value] }, value)) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "darask-dashboard-control", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u4E26\u3079\u66FF\u3048" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("select", { value: prefs.sort, onChange: (event) => update({ sort: event.target.value }), children: SORTS.map((value) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value, children: SORT_LABEL[value] }, value)) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "darask-dashboard-control", children: [
