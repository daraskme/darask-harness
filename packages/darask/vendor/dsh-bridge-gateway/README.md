...
Upgrade to the newest build: `dsh plugin --profile web add github:daraskme/dsh-bridge-gateway` again (or append `@latest` for the npm source). Then restart `dsh web`.
