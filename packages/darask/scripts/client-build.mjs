...
export async function buildClients(root) {
  ...
  for (const [file, result] of [[join(root, 'dist/client.js'), main], [join(vendor, 'client/client.js'), bridge]]) {
