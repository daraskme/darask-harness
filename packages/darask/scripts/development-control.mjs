...
const official = 'https://github.com/daraskme/dsh-darask.git';
...
export function createDevelopmentControl({ source, build, stop, start, install, expectedRemote = official }) {
  ...
  async function eligible() {
    ...
    if (!state.remoteReady || state.branch !== 'main') throw new Error('更新には daraskme/darask-harness (または dsh-darask) の origin と main ブランチを使用してください。');
    return state;
  }
